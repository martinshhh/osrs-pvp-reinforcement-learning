...
public class NhEnvironment implements AgentEnvironment {
    ...
    public List<Number> getObs() {
        ...
        return List.of(
                ...
                getTargetCurrentMagicGearAccuracy(),
                getTargetCurrentMagicGearStrength(),
                getTargetCurrentRangedGearAccuracy(),
                getTargetCurrentRangedGearStrength(),
                getTargetCurrentMeleeGearAccuracy(),
                getTargetCurrentMeleeGearStrength(),
